...
```
Maintenant l'inventaire "static" ou dynamic" est construit, il ne reste plus qu'à __exécuter les "Playbooks"__. Il y a deux approches pour le faire dans une infrastructure Azure:<br/>
