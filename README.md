...
__Première approche__, la plus simple, on pousse les configurations depuis un serveur en dehors d'Azure mais cela veut dire que pour pousser les configurations les serveurs cibles doivent avoir une IP publique et autoriser les flux entrants sur le port TCP 22 mais cela reste discutable au point de vu sécurité.<br/>
