...
__Première approche__, la plus simple mais la moins sécurisée, on pousse les configurations depuis un seveur Ansible hors Azure (On-Premise ou autres) sur des serveurs cibles qui s'exécutent dans Azure. Dans cette approche, on utilise une connexion SSH via Internet avec des IP publiques et des NSG autorisants les flux TCP 22 entrants<br/>
